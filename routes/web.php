    ...
    Route::middleware(['admin_auth'])->group(function(){
        Route::prefix('category')->group(function(){
            ...
            Route::prefix('user')->group(function(){
                ...
                Route::get('delete/user/list/{id}',[UserController::class,'delectUserList'])->name('admin#deleteUserList');
            });
            //contact list
            Route::prefix('user')->group(function(){
                Route::get('contact/list',[ContactController::class,'userContactList'])->name('admin#userContactList');
                Route::get('contact/delete/{id}',[ContactController::class,'deleteContact'])->name('admin#userDelete');
            });
...
//user category ပိုင်း
Route::group(['prefix'=>'user','middleware'=>'user_auth'],function(){
    Route::get('/homePage',[UserController::class,'home'])->name('user#home');
    Route::get('/filter/{id}',[UserController::class,'filter'])->name('user#filter');
    Route::get('/history',[UserController::class,'history'])->name('user#history');
    //self wrinting.........post
    Route::get('contact',[UserController::class,'userContact'])->name('user#userContact');
    Route::post('contact/message',[UserController::class,'userContactMessage'])->name('user#userContactMessage');
