                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('category#update')}} " method="post" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                ...
                                <input id="cc-pament" name="categoryName" type="text" value="{{ old('categoryName',$category->name)}} " class="form-control @error('categoryName') is-invalid
                            ...
                            <div>
                                <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                    <span id="payment-button-amount">Updte</span>
